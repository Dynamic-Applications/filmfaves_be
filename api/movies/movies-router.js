...
router.post("/", async (req, res) => {
    try {
        const { title, director, rate, genre, popular, description, image } = req.body;
        
        const result = await Movie.addMovie(title, director, rate, genre, popular, description, image);
